...
class UAV(object):
    ...
    def writeConfig(self, path="./"):
        ...
        filename = os.path.join(path, f"model.config")
    ...
    def buildSdf(self):
        ...
        pose.set("rotation_format", "quat_xyzw")
        ...
        # Add visual element
        brick = ET.SubElement(link, "visual")
        brick.set("name", "base_link_visual")
        pose = ET.SubElement(brick, "pose")
        pose.text = "0 0 0 0 0 0"
        geometry = ET.SubElement(brick, "geometry")
        box = ET.SubElement(geometry, "box")
        size = ET.SubElement(box, "size")
        size.text = "0.10 0.02 0.02"

        arrow = ET.SubElement(link, "visual")
        arrow.set("name", "base_link_arrow")
        pose = ET.SubElement(arrow, "pose")
        pose.text = "0.05 0 0 0 0 0.7854"
        geometry = ET.SubElement(arrow, "geometry")
        box = ET.SubElement(geometry, "box")
        size = ET.SubElement(box, "size")
        size.text = "0.04 0.04 0.022"

        material = ET.SubElement(arrow, "material")
        ambient = ET.SubElement(material, "ambient")
        ambient.text = "1.0 0.0 0.0"
        diffuse = ET.SubElement(material, "diffuse")
        diffuse.text = "1.0 0.0 0.0"
        specular = ET.SubElement(material, "specular")
        specular.text = "1.0 0.0 0.0"
        ...
        odometry_streaming_frequency.text = "20"
...
class Rotor(object):
    def __init__(self, channel):
        ...
        self._D        = 3*0.0254
        self._omegaMax = 4113.
        self._Mmax     = (0.12, 0.05)
        self._tau      = (0.020, 0.020)
        self._k        = 2.66e-7
        self._cm       = 0.01
        self._kappa    = 0.55
...
class Multirotor(UAV):
    ...
    def buildSdf(self):
        ...
        for i, rotor in enumerate(self._rotors):
            ...
            pose.text = "0 0 0 -1.5708 0 0"
            geometry = ET.SubElement(visual, "geometry")
            mesh = ET.SubElement(geometry, "mesh")
            scale = ET.SubElement(mesh, "scale")
            sc = [0.001*rotor._D/(5*0.0254) for _ in range(3)]
            sc[0] = sc[0] if rotor._dir == -1 else -sc[0]
            scale.text = ' '.join(str(x) for x in sc)
            uri = ET.SubElement(mesh, "uri")
            uri.text = f"model://{self._name}/meshes/5045_prop_cw.stl"
            ...
            turningDirection.text = "ccw" if rotor._dir == +1 else "cw"
            ...
            maxTorqueUp.text = str(rotor._Mmax[1])
    ...
    def calculateG1G2(self):
        ...
        G2_scaler = [0.5 * r._omegaMax**2 / (0.5*sum(r._tau)) for r in self._rotors]
